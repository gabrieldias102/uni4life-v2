        ...
        >
          <div className="mb-4 flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-text-tertiary">@{post.author?.username}</p>
            </div>
            <span className="rounded-full bg-highlight px-3 py-1 text-xs font-semibold uppercase tracking-wide text-text-secondary">
          ...
          <p className="mb-4 text-sm leading-6 text-text-tertiary">{post.content}</p>
        </article>
      ))}
    </div>
  );
